...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '26_12_70dd_b4d3_3da8').trim(),
  DATABASE:
  ...
  SUDO: process.env.SUDO || '24106813542',
  ...
  ANTIWORDS: process.env.ANTIWORDS || 'yo,salut,bonjour,fuck,bonsoir, bonne,essoya,bot',
